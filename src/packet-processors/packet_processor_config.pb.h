...
class PacketProcessorConfig_PpParametersEntry;
class PacketProcessorConfig_PpParametersEntryDefaultTypeInternal;
extern PacketProcessorConfig_PpParametersEntryDefaultTypeInternal _PacketProcessorConfig_PpParametersEntry_default_instance_;
class PortConfig;
class PortConfigDefaultTypeInternal;
extern PortConfigDefaultTypeInternal _PortConfig_default_instance_;
class PortConfig_PortParametersEntry;
class PortConfig_PortParametersEntryDefaultTypeInternal;
extern PortConfig_PortParametersEntryDefaultTypeInternal _PortConfig_PortParametersEntry_default_instance_;
...
class PacketProcessorConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PacketProcessorConfig) */ {
 ...
 private:
  ...
  public:
    ...
    void MergeFrom(const PacketProcessorConfig_PpParametersEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_PacketProcessorConfig_PpParametersEntry_default_instance_); }
...
class PortConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PortConfig) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  public:
  class PortConfig_PortParametersEntry : public ::google::protobuf::internal::MapEntry<PortConfig_PortParametersEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<PortConfig_PortParametersEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    PortConfig_PortParametersEntry();
    PortConfig_PortParametersEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const PortConfig_PortParametersEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_PortConfig_PortParametersEntry_default_instance_); }
    ::google::protobuf::Metadata GetMetadata() const;
  };
  ::google::protobuf::internal::MapField<
      PortConfig_PortParametersEntry,

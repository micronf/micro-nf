...
struct StaticDescriptorInitializer_packet_5fprocessor_5fconfig_2eproto {
  StaticDescriptorInitializer_packet_5fprocessor_5fconfig_2eproto() {
    protobuf_AddDesc_packet_5fprocessor_5fconfig_2eproto();
  }
} static_descriptor_initializer_packet_5fprocessor_5fconfig_2eproto_;
